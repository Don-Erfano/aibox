  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        {...props}
      >
        <div className="absolute top-0 left-1/2 mx-auto mt-2 hidden h-0.5 w-[100px] shrink-0 -translate-x-1/2 rounded-full bg-slate-200 group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  );
