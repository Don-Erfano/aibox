...
const AddSmsPage: FC = () => {
  ...
  const onSubmit: SubmitHandler<smsSchemaType> = (data) => {
  ...
  return (
    <FormContainer title={strings.add_new_sms_message}>
      <Form {...form}>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <FormWrapper>
            ...
            <RHFInput
              name="message_group"
              label={strings.smsGroupName}
              control={control}
              placeholder={strings.smsGroupName}
            />
